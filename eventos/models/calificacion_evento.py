...
class CalificacionEvento(models.Model):
    ...
    evento = models.ForeignKey(
        Evento, on_delete=models.CASCADE, related_name="calificacion_evento", verbose_name="Evento"
    )
    usuario = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="calificacion_evento", verbose_name="Usuario"
    )
