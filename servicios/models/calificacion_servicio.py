...
class CalificacionServicio(models.Model):
    ...
    servicio = models.ForeignKey(
        Servicio, on_delete=models.CASCADE, related_name="calificacion_servicio", verbose_name="Servicio"
    )
    usuario = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="calificacion_servicio", verbose_name="Usuario"
    )
